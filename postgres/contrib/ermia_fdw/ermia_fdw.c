 ...
 *
 * ermia_fdw.c
 *		  Foreign-data wrapper for ERMIA
 *
 * IDENTIFICATION
 *		  contrib/ermia_fdw/ermia_fdw.c
 *
 *-------------------------------------------------------------------------
 */
#include "postgres.h"
...
/*
 * Foreign-data wrapper handler function for ERMIA: return a struct with pointers
 * to my callback routines.
 */
Datum
ermia_fdw_handler(PG_FUNCTION_ARGS)
{
	FdwRoutine *routine = makeNode(FdwRoutine);

	/* Functions for scanning foreign tables */
	routine->GetForeignRelSize = ermiaGetForeignRelSize;
	routine->GetForeignPaths = ermiaGetForeignPaths;
	routine->GetForeignPlan = ermiaGetForeignPlan;
	routine->BeginForeignScan = ermiaBeginForeignScan;
	routine->IterateForeignScan = ermiaIterateForeignScan;
	routine->ReScanForeignScan = ermiaReScanForeignScan;
	routine->EndForeignScan = ermiaEndForeignScan;
