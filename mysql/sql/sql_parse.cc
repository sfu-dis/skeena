    ...
    case COM_QUERY: {
      ...
      while (!thd->killed && (parser_state.m_lip.found_semicolon != NULL) &&
        ...
        */
        ...
        // FIXME: Here we also have a notify send to the server, but we didn't figure
        // out how to get in the while loop here.
        LOG(FATAL) << "We found it !!";
        thd->send_statement_status();
...
/* SHOW PROFILE begin */
  ...
  // XXX: Only queue up upon commit. Should be enough to only enqueue
...
void dispatch_command_bottom_half(THD *thd, enum enum_server_command command,
  ...
  */
  // FIXME: Under high contention, this thd->mem_root may become nullptr
