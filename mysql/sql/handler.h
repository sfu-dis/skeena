...
class GlobalTransactionTable;  // from cross-engine transactions
...
struct handlerton {
  /**
   * A global transaction status table only useful for ERMIA hton
   */
  GlobalTransactionTable *gtt;
