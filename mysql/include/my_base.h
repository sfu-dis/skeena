...
/** Aborts caused by the violation of cross-engine commit protocol */
#define HA_ERR_COMMIT_PROTOCOL_ABORT 208
/** Aborts caused by SI conflicts */
#define HA_ERR_SI_CONFLICT 209
